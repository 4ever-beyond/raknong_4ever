...
pub mod add_event_question_reducer;
pub mod create_event_reducer;
pub mod deactivate_event_reducer;
pub mod delete_event_response_reducer;
pub mod event_question_table;
pub mod event_question_type;
pub mod event_response_table;
pub mod event_response_type;
pub mod event_table;
pub mod event_type;
pub mod register_profile_reducer;
pub mod submit_response_reducer;
pub mod toggle_verification_reducer;
pub mod user_profile_table;
pub mod user_profile_type;

pub use add_event_question_reducer::add_event_question;
pub use create_event_reducer::create_event;
pub use deactivate_event_reducer::deactivate_event;
pub use delete_event_response_reducer::delete_event_response;
pub use event_question_table::*;
pub use event_question_type::EventQuestion;
pub use event_response_table::*;
pub use event_response_type::EventResponse;
pub use event_table::*;
pub use event_type::Event;
pub use register_profile_reducer::register_profile;
pub use submit_response_reducer::submit_response;
pub use toggle_verification_reducer::toggle_verification;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AddEventQuestion { .. } => "add_event_question",
            Reducer::CreateEvent { .. } => "create_event",
            Reducer::DeactivateEvent { .. } => "deactivate_event",
            Reducer::DeleteEventResponse { .. } => "delete_event_response",
            Reducer::RegisterProfile { .. } => "register_profile",
            Reducer::SubmitResponse { .. } => "submit_response",
            Reducer::ToggleVerification { .. } => "toggle_verification",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::AddEventQuestion {
                event_id,
                label,
                field_type,
                options,
                is_required,
            } => __sats::bsatn::to_vec(&add_event_question_reducer::AddEventQuestionArgs {
            ...
            Reducer::CreateEvent {
                ...
                priority,
                passcode,
            } => __sats::bsatn::to_vec(&create_event_reducer::CreateEventArgs {
                title: title.clone(),
            ...
            Reducer::DeactivateEvent { event_id } => {
                __sats::bsatn::to_vec(&deactivate_event_reducer::DeactivateEventArgs {
                    event_id: event_id.clone(),
                })
            }
            Reducer::DeleteEventResponse { response_id } => {
                __sats::bsatn::to_vec(&delete_event_response_reducer::DeleteEventResponseArgs {
                    response_id: response_id.clone(),
                })
            }
            Reducer::RegisterProfile {
                nickname,
                entry_year,
                contact_channel,
                student_id,
            } => __sats::bsatn::to_vec(&register_profile_reducer::RegisterProfileArgs {
                nickname: nickname.clone(),
                entry_year: entry_year.clone(),
                contact_channel: contact_channel.clone(),
                student_id: student_id.clone(),
            }),
            Reducer::SubmitResponse {
                event_id,
                passcode,
                answers,
            } => __sats::bsatn::to_vec(&submit_response_reducer::SubmitResponseArgs {
                event_id: event_id.clone(),
                passcode: passcode.clone(),
                answers: answers.clone(),
            }),
            Reducer::ToggleVerification { target_identity } => {
                __sats::bsatn::to_vec(&toggle_verification_reducer::ToggleVerificationArgs {
...
pub struct DbUpdate {
    ...
    event_question: __sdk::TableUpdate<EventQuestion>,
    event_response: __sdk::TableUpdate<EventResponse>,
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "event_question" => db_update
                    .event_question
                    .append(event_question_table::parse_table_update(table_update)?),
                "event_response" => db_update
                    .event_response
                    .append(event_response_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.event_question = cache
            .apply_diff_to_table::<EventQuestion>("event_question", &self.event_question)
            .with_updates_by_pk(|row| &row.id);
        diff.event_response = cache
            .apply_diff_to_table::<EventResponse>("event_response", &self.event_response)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    ...
    event_question: __sdk::TableAppliedDiff<'r, EventQuestion>,
    event_response: __sdk::TableAppliedDiff<'r, EventResponse>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<EventQuestion>(
            "event_question",
            &self.event_question,
            event,
        );
        callbacks.invoke_table_row_callbacks::<EventResponse>(
            "event_response",
            &self.event_response,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        event_question_table::register_table(client_cache);
        event_response_table::register_table(client_cache);
        user_profile_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] =
        &["event", "event_question", "event_response", "user_profile"];
}
